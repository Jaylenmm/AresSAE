        ...
        <div className="p-6">
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">{analysis.ev_percentage}%</div>
              <div className="text-xs text-gray-500 mt-1">Expected Value</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900">{analysis.hit_probability}%</div>
              <div className="text-xs text-gray-500 mt-1">Hit Probability</div>
            </div>
            <div className="text-center">
              <div className={`text-2xl font-bold ${scoreColor}`}>{analysis.recommendation_score}/100</div>
          ...
          {analysis.best_book && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
              <p className="text-sm text-blue-900">
                <span className="font-semibold">Best odds:</span> {analysis.best_odds} at {analysis.best_book}
              </p>
            </div>
          )}
