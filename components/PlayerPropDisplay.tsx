    ...
    <div className="space-y-4 overflow-hidden">
      ...
      <div className="bg-black/30 rounded-lg p-4 border border-white/10">
        ...
        {loadingStats ? (
          ...
          <div className="text-center text-gray-500 py-6">
            <p className="text-sm">We are working on getting full stat coverage for this player.</p>
            <p className="text-xs mt-1 text-gray-600">Thanks for using Ares today!</p>
          </div>
        ) : (
          <div className="text-center text-gray-500 py-6">
