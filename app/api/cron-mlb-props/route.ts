...
export async function GET(request: Request) {
  ...
  const books = booksParam
    ...
    : ['draftkings', 'fanduel', 'betmgm', 'caesars', 'espnbet', 'pinnacle', 'circa', 'bookmaker']
  ...
  return NextResponse.json({ success: true, sport: 'MLB', phase: 'props', details: data?.details || data || {} })
}
